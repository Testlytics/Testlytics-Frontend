...
const tableData = {
    columns: ["Subjects", "Test 1", "Test 2", "Test 3"], // Column headers
    data: [
...
Default.args = {
  profilePicture: <ProfilePicture imageUrl="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" />,
  studentDetails: <StudentDetails firstName="John Doe" studentId="12345" rank="1" />,
  tableData: tableData,
  barGraphData: [
    { label: "Math", value: 95 },
  ...
  rectangleOneText: "Performance",
  rectangleTwoText: "Improvements",
};
